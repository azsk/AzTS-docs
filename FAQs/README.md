...
7. [How can I migrate classic Application Insights to Workspace-based? If I migrate Application Insights AzSK-AzTS-AppInsights-xxxxx to Workspace-based, will there be any impact to AzTS scan?](#7-how-can-i-migrate-classic-application-insights-to-workspace-based-if-i-migrate-application-insights-azsk-azts-appinsights-xxxxx-to-workspace-based-will-there-be-any-impact-to-azts-scan)
...
### **7. How can I migrate classic Application Insights to Workspace-based? If I migrate Application Insights AzSK-AzTS-AppInsights-xxxxx to Workspace-based, will there be any impact to AzTS scan?**
It is recommended to migrate to classic Application Insights to Workspace-based before retirement date(29th February, 2024) to ensure most reliable experience. You can follow steps mentioned in detail [here](https://learn.microsoft.com/en-us/azure/azure-monitor/app/convert-classic-resource#migrate-your-resource) for migration using any one of the below listed approaches.
...
As per latest communication from Azure, for Application Insights not migrated to Workspace-based by retirement date, ingestion will continue until it is auto-migrated.AzTS scan is expected to be non impacted in such cases.  However, for reliable experience, it is recommended to switch to Workspace-based mode by 29th February, 2024.
