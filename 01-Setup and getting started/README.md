...
>
>     **Note:** VNET integrated setup is not recommended as of now due to ongoing issue with Private link scope.
>
...
|EnableVnetIntegration | Switch to enable VNet integration for AzTS setup. Enabling VNet integration for AzTS setup, ensures that all critical resources like storage, function apps, log analytics workspace etc that are part of AzTS setup, are not accessible over public internet. </br>**Note:** VNET integrated setup is not recommended as of now due to ongoing issue with Private link scope.|FALSE|
