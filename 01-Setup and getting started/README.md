...
> FAQ for guidance on migrating classic Application Insights to Workspace-based [here](../FAQs/README.md/#7-how-can-i-migrate-classic-application-insights-to-workspace-based-if-i-migrate-application-insights-azsk-azts-appinsights-xxxxx-to-workspace-based-will-there-be-any-impact-to-azts-scan).
