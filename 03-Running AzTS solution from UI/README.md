...
2. Subscription scan should have completed for the day. The steps to validate this has been specified under [this section](/01-Setup%20and%20Getting%20started/README.md#3-verifying-that-tenant-security-solution-installation-is-complete).
