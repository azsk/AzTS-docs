...
|----|----|----|
| Authorization| Bearer Token which can be generated by following steps here(07-On%20demand%20scan%20as%20an%20API#generate-authentication-token-to-access-api-endpoints) | Yes|
