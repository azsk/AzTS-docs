...
class ScannerConstants
{
    ...
    static [Hashtable] $FunctionApp = @{
            SubscriptionInvProcessor = 'ATS_1_SubscriptionInvProcessor'
            BaselineControlsInvProcessor = 'ATS_2_BaselineControlsInvProcessor'
            SubscriptionRBACProcessor = 'ATS_3_SubscriptionRBACProcessor'
            WorkItemScheduler = 'ATS_4_WorkItemScheduler'
    }
