...
- **Azure Portal** 
	...
	To enable automatic updates: Go to Azure portal --> your 'Cloud Service' --> under 'settings' section select 'configure' tab --> set 'OS version' to 'automatic' from drop-down menu --> Select 'Save'.
