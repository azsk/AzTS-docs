...
- ARM API to lists all the HDInsight clusters under the subscription: - /subscriptions/{subscriptionId}/providers/Microsoft.HDInsight/clusters?api-version=2018-06-01-preview 
 <br />
