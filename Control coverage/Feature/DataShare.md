...
- [Azure_DataShare_Audit_Enable_Diagnostic_Settings](#azure_datafactory_audit_enable_diagnostic_settings)
...
- **Azure Portal** 
    - To Configure 'Diagnostic settings' for Datashare, go to Azure Portal --> Your Datashare Resource --> Diagnostic settings --> Click on Enable Shares, Share Subscriptions, Sent Share Snapshots, Received Share Snapshots and All Metrics.
